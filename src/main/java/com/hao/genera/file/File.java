...
import com.hao.genera.constant.SystemConstant;
...
public class File {
	...
	public File(MultipartFile file, String dir) {
		this.dir = dir;
		this.file = file;
		this.fileName = file.getName();
		this.originalFileName = file.getOriginalFilename();
		this.uploadPath = FileUtil.formatUrl(java.io.File.separator + SystemConstant.me().getUploadRealPath() + java.io.File.separator + dir + java.io.File.separator + DateUtil.format(new Date(), "yyyyMMdd") + java.io.File.separator + this.originalFileName);
		this.uploadVirtualPath = FileUtil.formatUrl(SystemConstant.me().getUploadCtxPath().replace(SystemConstant.me().getContextPath(), "") + java.io.File.separator + dir + java.io.File.separator + DateUtil.format(new Date(), "yyyyMMdd") + java.io.File.separator + this.originalFileName);
	}

	public File(MultipartFile file, String dir, String uploadPath, String uploadVirtualPath) {
		this(file, dir);
		if (null != uploadPath) {
