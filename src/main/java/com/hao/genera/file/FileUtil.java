...
import com.hao.genera.utils.StringPool;
...
public class FileUtil {
	 ...
	 * @return BladeFile
	 */
	public static File getFile(MultipartFile file, String dir) {
	 ...
	 * @return BladeFile
	 */
	public static File getFile(MultipartFile file, String dir, String path, String virtualPath) {
		return new File(file, dir, path, virtualPath);
	}
	 ...
	 * @return BladeFile
	 */
	public static List<File> getFiles(List<MultipartFile> files) {
	 ...
	 * @return BladeFile
	 */
	public static List<File> getFiles(List<MultipartFile> files, String dir) {
	 ...
	 * @return BladeFile
	 */
	public static List<File> getFiles(List<MultipartFile> files, String dir, String path, String virtualPath) {
		List<File> list = new ArrayList<>();
		for (MultipartFile file : files) {
			list.add(new File(file, dir, path, virtualPath));
		}
		return list;
	}
